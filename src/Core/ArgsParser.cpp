...
namespace VerifyTAPN {
	...
	void ArgsParser::Initialize()
	{
		...
		parsers.push_back(boost::make_shared<SwitchWithArg>("w", CLEANUP_OPTION, "Specify the desired cleanup method for tplib max-plus polyhedra.\n 0: Default\n 1: Output sensitive",0));
	};
