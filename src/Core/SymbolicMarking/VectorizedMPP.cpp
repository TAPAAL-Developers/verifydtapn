...
//			Cleanup();
	...
	/*
	 * The uncommented code is a combination of Extrapolation49 and Extrapolation411.
	 * Currently calling the functions separately to match TPlib implementation.
	...
	void VectorizedMPP::Extrapolate(const int* maxConstants) {
		...
		Cleanup();
		//ExtrapolateNew(maxConstants);
		Extrapolate49(maxConstants);
		Extrapolate411(maxConstants);
		//Extrapolate413(maxConstants);
	}

	void VectorizedMPP::ExtrapolateNew(const int* maxConstants) {
