...
namespace VerifyTAPN {
	 ...
	 */
	std::vector<int> VectorizedMPPMarking::ArgmaxPsi(const std::vector<int>& P, int Pgens, int dim,
			const std::vector<int> w, int skipgen) const {
		int maxPsi = INT_MIN;
		std::vector<int> Zgens;
	 ...
	 */
	bool VectorizedMPPMarking::ExSetContainsPoint(const std::vector<int>& C, int Cgens,
